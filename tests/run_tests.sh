...
for suite in test_archetypes test_zombiethreat test_doors test_scavenge test_vehicles test_debug test_signs test_anim test_movement test_combat test_population; do
    echo "== $suite =="
